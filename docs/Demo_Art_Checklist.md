...
| A2 | Room lighting follows the view outside — no daylight rays at night | ✅ live | Night = lamp-lit repaint (glass mask 0.00% diff vs day, desk mask 1%); Yua + hands modulated cool at night, warm at sunset. Sunset/rain/others use the day room with tint/overcast. **Not done:** a true sunset repaint (currently a warm tint) — only if the tint reads flat. |
